...
<nav in:fly={{ x: -100, duration: 500, delay: 500 }} out:fly={{ x: 100 }}>
	<ul>
		...
		<li class:active={$page.url.pathname === '/lab/infotech/dbms'}>
			<a href="/lab/infotech/dbms">DBMS</a>
		</li>
		<li class:active={$page.url.pathname === '/lab/infotech/framework'}>
			<a href="/lab/infotech/framework">Framework</a>
		</li>
